using HMS_Software_V_2.Common_UseForms.UserControls;
using HMS_Software_V_2.Reception.UserControls;
using System;
...
using static HMS_Software_V_2.Doctor_OPD.DoctorCheck_PatientCheck;

using Newtonsoft.Json;
using HMS_Software_V_2.Doctor_OPD; //To convert data to json fomat
using HMS_Software_V_2.Common_UseForms.OOP;



namespace HMS_Software_V_2.Common_UseForms
{
